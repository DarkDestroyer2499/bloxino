...
**Visual block programming for Arduino — free, offline, in Ukrainian and English.**
...
- Any Arduino board (Uno, Nano, Mega, Leonardo, or ESP32)
- USB cable
...
- Email: contact@bloxino.org
- Website: [bloxino.org](https://bloxino.org)

## License

Free for personal, educational, and non-commercial use. See [LICENSE.txt](LICENSE.txt) for full terms.

Copyright (c) 2026 Dmytro Skrypka. All rights reserved.
